...
class DrawingCanvas:
    ...
    def draw_line(self, start_pos, end_pos):
        ...
        pygame.draw.line(
            self.surface, self.brush_color, start_pos, end_pos, self.brush_size
        )
...
class StreamlitDrawingCanvas:
    ...
    def create_canvas(self):
        ...
        try:
            ...
            st.error(
                "streamlit-drawable-canvas not installed. Please install it with: pip install streamlit-drawable-canvas"
            )
            return None
